...
export class GameOptions extends GameOptionsBase {
    ...
    constructor(params: URLSearchParams) {
        ...
        this.tuxedoRules = URLSearchParamsEx.getBool(params, "tuxedoRules", false);
    }
    ...
    public toURLSearchParams(): URLSearchParams {
        ...
        URLSearchParamsEx.setBool(params, "tuxedoRules", this.tuxedoRules, false);
        return params;
    }
}
