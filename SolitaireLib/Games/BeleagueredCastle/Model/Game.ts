...
export class Game extends GameBase implements IGame {
    ...
    protected *restart_(rng: prand.RandomGenerator) {
        ...
        // Find and place Aces in the 4 foundations (Clubs, Diamonds, Hearts, Spades)
        ...
        // Deal the remaining 48 cards face up fanned into the 8 tableau piles round-robin (6 cards each)
        for (let i = 0; i < 6; ++i) {
            for (let j = 0; j < 8; ++j) {
